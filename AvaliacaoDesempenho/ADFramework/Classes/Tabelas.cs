...
namespace ADFramework.Classes
{
    ...
    public class TabClassificacao
    {
        ...
        public class Metodo
        {
            ...
            public static object Insert(int Cla_Qua_Id, string Cla_Descricao, decimal Cla_Cotacao)
            {
                object Cla_Id = null;
                ...
                try
                {
                    ...
                    SQLParam[2] = new SqlParameter("@" + TabClassificacao.Cotacao, SqlDbType.Decimal, TabClassificacao.Comprimento.Cotacao);
            ...
            public static void Update(int Cla_Qua_Id, string Cla_Descricao, decimal Cla_Cotacao, int Cla_Id)
            {
                SqlCommand SqlCommand = new SqlCommand(Procedimento.Update, SqlConnection);
                SqlCommand.CommandType = CommandType.StoredProcedure;
                SqlParameter[] SQLParam = new SqlParameter[4];
