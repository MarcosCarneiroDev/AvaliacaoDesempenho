        ...
        private void _VerificaSessao(DataTable user)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        menu_item_1.Attributes.Add("style", "visibility:collapse;");
                        menu_item_2.Attributes.Add("style", "visibility:collapse;");
                        menu_item_3.Attributes.Add("style", "visibility:collapse;");
                        menu_item_4.Attributes.Add("style", "visibility:collapse;");

                    }
                    else
                    {
                        menu_item_5.Attributes.Add("style", "visibility:collapse;");
                        _CarregaDados(user);
                    }                    
                }
            }
